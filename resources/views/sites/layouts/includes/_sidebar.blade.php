<div class="sidebar">
    ...
    <div class="row-fluid">
      <a href="{{route('profil')}}" class="{{ (request()->is('profil/*')) ? 'active' : '' }} {{ (request()->is('profil')) ? 'active' : '' }}">
          <i class="fas fa-user"></i><span>Profil</span>
      </a>
      @if(auth()->user()->role=='user')
      <a href="/transaksi" class="{{ (request()->is('transaksi')) ? 'active' : '#' }} {{ (request()->is('transaksi/*')) ? 'active' : '#' }}">
